	...
	return (
		...
		>
			...
			<div className="flex items-start justify-between mb-4">
				<div
					className={`p-2.5 rounded-lg text-primary-400 group-hover:bg-primary-600 group-hover:text-white transition-colors ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}
				>
				...
				<div className="text-right">
					...
					<span
						className={`text-sm block ${isDark ? 'text-gray-500' : 'text-gray-500'}`}
					>
						pts
					</span>
				</div>
			...
			{/* Title */}
			<h3
				className={`text-lg font-semibold mb-2 group-hover:text-primary-600 transition-colors line-clamp-1 ${isDark ? 'text-white' : 'text-gray-900'}`}
			>
				{challenge.title}
			</h3>
