		...
		<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			...
			<div className="mb-8">
				...
				<p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
					Track all your flag submission attempts
				</p>
			</div>
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
				...
				<Card className="p-4 text-center">
					<Flag className="h-6 w-6 text-primary-500 mx-auto mb-2" />
					<p
						className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}
					>
						{successRate}%
					...
					{filteredSubmissions.map((submission) => {
						...
						return (
							<Link
								...
								className={`flex items-center justify-between p-4 transition-colors group ${isDark ? 'hover:bg-gray-800/50' : 'hover:bg-gray-50'}`}
							>
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<div
											className={`flex items-center gap-3 text-sm ${isDark ? 'text-gray-500' : 'text-gray-500'}`}
										>
